...
const stats = [
  {
    ...
    description: "Pure, clean and ethically sourced skincare.",
  },
  {
    value: "60%",
    label: "Customer Satisfaction",
    description: "Trusted by beauty-conscious customers worldwide.",
  },
  {
    value: "53%",
    label: "Less Packaging",
    description: "Eco-friendly design for a greener planet.",
  },
  {
    value: "6/10",
    label: "Recommend Us",
    description: "Loved and recommended by our customers.",
  },
];
...
const packagingFeatures = [
  {
    ...
    description:
      "Crafted with pure, nurturing ingredients for skin that glows.",
  },
  {
    icon: Sparkles,
    title: "Cruelty-Free",
    description: "Our products are never tested on animals, ever. Humane.",
  },
  {
    icon: Package,
    title: "Expert Approved",
    description:
      "Carefully tested for skincare solutions with visible results.",
  },
  {
    icon: Truck,
    title: "Free Shipping",
    description: "Delivered to your doorstep fast free, within most locations.",
  },
];
          ...
          <div className="relative container-kanva section-padding flex items-center top-30 min-h-[60vh]">
            <div className="max-w-xl">
              ...
              <p className="text-lg text-primary-foreground/80 leading-relaxed mb-6">
                At Skyntales, we blend nature and science to create skincare
                that transforms, empowers, and respects the planet.
              </p>
              <Link
                to="/about"
                className="text-primary-foreground flex items-center gap-2 hover:gap-3 transition-all"
              >
                Our Story <span>→</span>
              </Link>
            </div>
          ...
          <div className="container-kanva">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="text-center p-10 rounded-2xl bg-background"
                >
          ...
          <div className="container-kanva">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="bg-white h-150 p-10 rounded-3xl">
                <span className="text-sm font-medium text-sage tracking-wide uppercase mb-4 block">
                  About Us
                </span>
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Skyntales is built on the belief that skincare should enhance
                  your natural beauty, not mask it. By combining the best of
                  science with natural ingredients, we bring effective and
                  beautiful products to your skincare journey.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 bg-white h-150 p-10 rounded-3xl">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Skyntales embodies a simple goal: skincare that works in
                  harmony with your skin and the planet. From handpicked
                  ingredients to beautiful blends, every product tells a story
                  of clean beauty, natural efficiency, and sustainable skincare
                  solutions.
                </p>
                <div className="space-y-3">
              ...
              <div className="order-1 lg:order-2">
                <div className="rounded-3xl overflow-hidden">
                  <img
                    src={ecoProduct}
                    alt="Why your skin deserves the best"
                    className="w-full h-[600px] object-cover"
                  />
                </div>
              </div>
        ...
        <section className="section-padding bg-white">
          <div className="container-kanva text-center">
            <div className="flex justify-center mb-6">
              ...
              >
                <path
                  d="M50 10C30 30 20 50 20 70C20 85 35 95 50 95C65 95 80 85 80 70C80 50 70 30 50 10Z"
                  opacity="0.3"
                />
            ...
            <div className="mt-8">
              <span className="text-sm font-medium text-muted-foreground tracking-wide uppercase block mb-2">
                Our Mission
              </span>
              <Link
                to="/shop"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[50vh]">
              <div>
                ...
                <p className="text-lg text-primary-foreground/80 leading-relaxed mb-8 max-w-md">
                  ...
                  ingredients to ensure safe, effective, and gentle care for
                  your skin.
                </p>
                <div className="space-y-3">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  At Skyntales, sustainability drives every decision we make.
                  Our packaging is designed to reduce waste and protect the
                  planet while maintaining the quality and freshness of our
                  products.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  {packagingFeatures.map((feature) => (
                    ...
                    >
                      <feature.icon
                        className="h-12 w-12 text-sage mb-3"
                        strokeWidth={1.5}
                      />
                      <h4 className="font-heading font-medium mb-1">
                        {feature.title}
                      </h4>
                      <p className="text-sm text-muted-foreground">
                        {feature.description}
